...
<div class="card">
    <div class="card-body">
        <form class="row g-3" action="{{ route('merchant.updateProfile', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <h3>Profile</h3>
            ...
            <div class="col-12">
                ...
                <textarea name="company_desc" class="form-control" rows="5">{{ old('company_desc', $profile->description ?? '') }}</textarea>
            </div>
            ...
            <div class="col-12">
                ...
                <a href="{{ route('merchant.profile', ['id' => $data->id]) }}" class="btn btn-danger">Cancel</a>
            </div>
        </form>
